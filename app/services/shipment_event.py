...
class ShipmentEventService(BaseService):
    ...
    discription: str = None,
        ...
        new_event = ShipmentEvent(
            location=location,
            status=status,
            discription=discription if discription else self._generate_discription(status, location),
    ...
    def _generate_discription(self, status: ShipmentStatus, location: int):
        match status:
